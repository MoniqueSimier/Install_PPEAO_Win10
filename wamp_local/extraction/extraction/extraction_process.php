<?php 
//*****************************************
// extraction_process.php
//*****************************************
// Created by Yann Laurent
// 2009-06-30 : creation
//*****************************************
// Ce programme gere le processus d'extraction par filiere 
//*****************************************
...
include $_SERVER["DOCUMENT_ROOT"].'/process_auto/functions.php'; // Recupere les fonctions pour ecrire dans le fichier log
// Variables standard
$CRexecution = "<br/>";
...
//echo "pays id = ".$SQLPays."<br/>";
//echo "Systeme id = ".$SQLSysteme."<br/>";
//echo "Secteur id = ".$SQLSecteur."<br/>";
//echo "Engin id = ".$SQLEngin."<br/>";
//echo "GTEngin id = ".$SQLGTEngin."<br/>";
//echo "Campagne id = ".$SQLCampagne."<br/>";
//echo "Especes id = ".$SQLEspeces."<br/>";
//echo "Famille id = ".$SQLFamille."<br/>";
