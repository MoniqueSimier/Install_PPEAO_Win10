...
<div id="main_container" class="home">
	<h2 style="padding-left:120px">consulter des données : extraction des p&ecirc;ches artisanales</h2>
...
<?php 
	...
	//echo "<span class=\"changeSel2\"><a href=\"/extraction/extraction/extraction_filieres_art.php".$inputXML.$InputLog."&gselec=y&tab=".$numTab."&modiffil=y&action=".$typeAction."\" >[modifier la s&eacute;lection de la fili&egrave;re en cours]</a></span></li>";
	echo "</ul></div>";
	if (!($exportFichier)) {	?>
	<div id="exportFic2">
